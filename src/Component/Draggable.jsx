...
export default function Draggable(props) {
    const { id, type, info, x, y, condition, treeUpdate, deleteSource, style, onClick, status } = props
    ...
    function dragStart(ee) {
        ...
        ee.dataTransfer.setData('status', status); //状态0是人 1是车
    }
    ...
    return (
        <div
            ...
            style={{
                background: shadow && /big/.test(info) ? 'rgba(255, 153, 0, 0.0980392156862745)' : '',
