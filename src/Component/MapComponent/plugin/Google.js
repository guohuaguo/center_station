...
let getPlugin = function(ip) {
    ...
    let r2 = function(point) {
        let wgsLngLat = ol.proj.transform(point, 'EPSG:3857', 'EPSG:4326');
        return [parseFloat(wgsLngLat[0].toFixed(12)),parseFloat(wgsLngLat[1].toFixed(12))]
    };
    //0 返回底图用的Promise
    ...
    //4 最小层级
    //5 最大层级
    return [r0, r1, r2, 'EPSG:3857', 2, 20];
};
getPlugin;
